...
module.exports = class BrainSolution {
    constructor(name, isRNN, statisticCallback) {
        ...
        if (isRNN) {
            ...
            this.net = new brain.NeuralNetwork({
                ...
                hiddenLayers: [40,30, 40],     // array of ints for the sizes of the hidden layers in the network
            ...
            this.trainOptions = {
                ...
                learningRate: 0.005,    // multiply's against the input and the delta then adds to momentum
                momentum: 0.1,        // multiply's against the specified "change" then adds to learning rate for change
                callback: () => {this.save()},       // a periodic call back that can be triggered while training
                callbackPeriod: 1,   // the number of iterations through the training data between callback calls
    ...
    train(steps, statisticCallback) {
        ...
        return this.net.trainAsync(trainData, this.trainOptions);
    }
